...
export function populateScreenHTML() {
    ...
    document.getElementById('settings-screen').innerHTML = `<h2 class="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-4 text-center">Quản lý từ vựng</h2><div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg mb-6"><h3 id="vocab-form-title" class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">Thêm từ mới</h3><div class="grid grid-cols-1 md:grid-cols-2 gap-4"><input type="text" id="vocab-word" placeholder="Từ vựng (tiếng Anh)" class="p-2 border rounded dark:bg-gray-600 dark:border-gray-500"><input type="text" id="vocab-meaning" placeholder="Nghĩa (tiếng Việt)" class="p-2 border rounded dark:bg-gray-600 dark:border-gray-500"><input type="text" id="vocab-example" placeholder="Ví dụ (không bắt buộc)" class="p-2 border rounded dark:bg-gray-600 dark:border-gray-500"><input type="text" id="vocab-category" placeholder="Chủ đề (không bắt buộc)" class="p-2 border rounded dark:bg-gray-600 dark:border-gray-500"></div><div class="flex gap-2 mt-4"><button id="vocab-submit-btn" onclick="handleVocabSubmit()" class="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-lg">Thêm từ</button><button id="vocab-cancel-edit-btn" onclick="cancelVocabEdit()" class="w-full bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded-lg hidden">Hủy</button></div><p id="vocab-form-feedback" class="text-red-500 text-sm mt-2 h-4"></p></div><div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg mt-6"><h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">Import từ Google Sheet</h3><div class="bg-blue-100 dark:bg-blue-900 border-l-4 border-blue-500 text-blue-700 dark:text-blue-200 p-4 rounded-lg mb-4 text-sm" role="alert"><p class="font-bold">Lưu ý:</p><ul class="list-disc list-inside mt-1"><li>Các từ vựng trùng lặp sẽ được bỏ qua.</li><li>Sheet cần có 4 cột: <strong>word</strong>, <strong>meaning</strong>, <strong>example</strong>, <strong>category</strong>.</li><li>Sheet cần được chia sẻ với quyền <strong>"Anyone with the link" (Bất kỳ ai có đường liên kết)</strong>.</li></ul></div><input type="url" id="gsheet-url" class="w-full p-2 border rounded dark:bg-gray-600 dark:border-gray-500" placeholder="Dán link Google Sheet vào đây..."><button onclick="importFromGoogleSheet()" class="w-full mt-2 bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg">Import</button><div id="import-feedback" class="mt-2 h-5 text-sm"></div></div><h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2 mt-6">Danh sách của bạn</h3><div id="vocab-management-list" class="space-y-2 max-h-80 overflow-y-auto p-2 bg-gray-50 dark:bg-gray-900/50 rounded-lg"></div>`;
